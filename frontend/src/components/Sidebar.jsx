...
export default function Sidebar() {
  return (
    <div className='flex flex-col gap-y-12 w-48 mx-0 mt-10 bg-slate-600'>
        <Header fontSize={"text-lg"} className =" justify-center items-center"/>
        ...
        <div className='flex flex-col gap-y-8 pl-6 '>
             ...
             <div className='text-white flex gap-x-4'><Pencil /><div>create a post</div></div>
